...
#### 2.Model training
Open "[keypoint_classification_EN.ipynb](keypoint_classification_EN.ipynb)" in Jupyter Notebook and execute from top to bottom.<br>
...
#### 2.Model training
Open "[point_history_classification_EN.ipynb](point_history_classification_EN.ipynb)" in Jupyter Notebook and execute from top to bottom.<br>
